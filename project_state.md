...
- Latest source-icon verification: the Landing and `/codex` source actions use the reusable GitHub mark instead of an outbound arrow. Docker lint, strict typecheck, 70 tests, production build, and four public Playwright journeys across 375px/768px/1440px passed; rendered `/codex` inspection confirmed icon alignment.
