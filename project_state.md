...
No mission is active. Mission 25 resolved the Next.js 16.3/Vercel adapter collision by using Vercel-native output under `VERCEL=1` while preserving standalone output for Docker; public redeployment remains pending.
