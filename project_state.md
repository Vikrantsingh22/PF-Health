...
No mission is active. Mission 27 added reviewer-facing source links to the landing build proof and public `/codex` journey, with isolated external-tab behavior and responsive verification. The repository may remain private until the submission deadline; unauthorised reviewers will see GitHub's private/not-found boundary until it becomes public.
